...
const Footer = () => {
  return (
    <>
      <div className="flex flex-col gap-4 bg-[#f2f2f2] p-20 text-xs">
        <div className="flex flex-col gap-2">
          <h2 className="font-extrabold"> PRODUCT OFFERING</h2>
          <p className="leading-5">
            ...
            From UAE, Trip Planner, Forex Card, Buy Foreign Currency, Gift
            Cards, Gift, Wedding Gift, Anniversary Gift, Birthday Gift, Diwali
            Gift, Valentines Gift, Farewell Gift, Christmas Gift, New Year Gift,
            Trip Money, Trip Ideas, Travel Blog, PNR Status, MakeMyTrip
            Advertising Solutions, One Way Cab
          </p>
        </div>
        <div className="flex flex-col gap-2">
          <h2 className="font-extrabold">MAKEMYTRIP</h2>
          <p className="leading-5">
            About Us, Investor Relations, Careers, MMT Foundation, Legal
            Notices, CSR Policy, myPartner - Travel Agent Portal, Foreign
            Exchange, List your hotel, Partners- Redbus, Partners- Goibibo,
            Advertise with Us, Holiday-Franchise, Partners- BookMyForex, RedBus
            Ferry Malaysia, RedBus Ferry Singapore, redBus Vietnam, redBus
            Cambodia, Things to Do in Malaysia, Things to Do in Singapore
          </p>
        </div>
        <div className="flex flex-col gap-2">
          <h2 className="font-extrabold">ABOUT THE SITE</h2>
          <p>
            Customer Support, Payment Security, Privacy Policy, Cookie Policy,
            User Agreement, Terms of Service, Franchise Offices, Make A Payment,
            Work From Home, Escalation Channel, Report Security Issues
          </p>
        </div>
        <div className="flex flex-col gap-2">
          <h2 className="font-extrabold">TOP HOTELS IN INDIA</h2>
          <p className="leading-5">
            ...
            Palace Chennai, The Leela Palace Udaipur, Taj Lake Palace Udaipur,
            Jw Marriott Chandigarh, Alila Diwa Goa, Le Meridien Goa, Taj Lands
            End Mumbai, Itc Grand Chola Chennai, Itc Maratha Mumbai, Oberoi
            Udaivilas, Jai Mahal Palace Jaipur, Taj Mahal Tower Mumbai, Marriott
            Suites Pune, Park Hyatt Chennai, The Leela Palace Jaipur, Jw
            Marriott Mumbai Sahar, Jw Marriott Mumbai Juhu, The Ritz Carlton
            Bengaluru, The Oberoi New Delhi, Taj Resort & Convention Centre Goa,
            Taj Bengal Kolkata, Taj Coromandel Chennai, The Oberoi Gurgaon, The
            Westin Goa, Jw Marriott Hotel Pune, The Leela Palace New Delhi, Taj
            West End Bengaluru, The Taj Mahal Palace Mumbai, Best Hotels in
            India
          </p>
        </div>
        <div className="flex flex-col gap-2">
          <h2 className="font-extrabold">TOP INTERNATIONAL HOTELS</h2>
          <p className="leading-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="leading-5">
            ...
            Delhi to Khajuraho Flights, Cochin to Agatti Island Flights, Hotels
            in Delhi, Hotels in Mumbai, Hotels In Goa, Hotels In Jaipur, Hotels
            In Ooty, Hotels In Udaipur, Hotels in Puri, Hotels In North Goa,
            Hotels In Rishikesh, Honeymoon Packages, Kerala Packages, Kashmir
            Packages, Ladakh Packages, Goa Packages, Thailand Packages, Sri
            Lanka Visa, Thailand Visa, Explore Goa, Explore Manali, Explore
            Shimla, Explore Jaipur, Explore Srinagar
          </p>
        </div>
        <div className="flex flex-col gap-2">
          <h2 className="font-extrabold">IMPORTANT LINKS</h2>
          <p className="leading-5">
            Cheap Flights, Flight Status, Kumbh Mela, Domestic Airlines,
            International Airlines, Indigo, Spicejet, GoAir, Air Asia, Air
            India, Indian Railways, Trip Ideas, Beaches, Honeymoon Destinations,
        ...
        <div className="flex flex-col gap-2">
          <h2 className="font-extrabold">CORPORATE TRAVEL</h2>
          <p className="leading-5">
            ...
            Business Travel Solutions, GST Invoice for Bus, Corporate Bus
      ...
      <div className="flex gap-10 bg-[#e7e7e7] px-20 py-10">
        <div className="flex flex-1 flex-col gap-6">
          <h2 className="font-semibold">Why MakeMyTrip?</h2>
          <p className="text-xs">
        ...
        <div className="flex flex-1 flex-col gap-6">
          <h2 className="font-semibold">Booking Flights with MakeMyTrip</h2>
          <p className="text-xs">
      ...
      <div className="flex h-40 items-center justify-between bg-black px-20 text-white">
        <div className="flex gap-10">
          <FaXTwitter className="size-8" />
          <FaFacebookF className="size-8" />
        </div>
        <div className="flex flex-col font-semibold">
          <h2>© 2024 MAKEMYTRIP PVT. LTD.</h2>
